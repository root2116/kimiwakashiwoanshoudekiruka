...
function AnswerTitle(props) {
    ...
    const handleConfirm = () => {
        ...
        if (userAnswer === lyrics[currentIndex].title) {
            setFeedback(true);
    ...
    const handleNext = () => {
        const history = {
            ...
            lyric: lyrics[currentIndex].part,
            userAnswer: userAnswer,
            correctAnswer: lyrics[currentIndex].title,
            isCorrect: feedback
        };
    ...
    return (
        <Grid container direction="column" spacing={2}>
            ...
            <Grid item>
                <Typography variant="h6">{currentIndex+1}問目</Typography>
            </Grid>
            <Divider />
            <Grid item>
                {lyrics[currentIndex] && <Typography variant="h5">{lyrics[currentIndex].part}</Typography>}
            </Grid>
            <Grid item>
            ...
            <Grid item>
                <Typography variant="h6">
                    {feedback != null && "正解: " + lyrics[currentIndex].title}
                    　
                </Typography>
            </Grid>
            <Grid item>
